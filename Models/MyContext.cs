//#9  Get the info below from Setup and Model from platform and copy it below
...
namespace User2.Models;  // ********* #1 its not yourprojectname... change to Pet or your model class name **************
